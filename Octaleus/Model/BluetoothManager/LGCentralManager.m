...
- (void)centralManager:(CBCentralManager *)central
 didDiscoverPeripheral:(CBPeripheral *)peripheral
     advertisementData:(NSDictionary *)advertisementData
                  RSSI:(NSNumber *)RSSI
{
    if ([advertisementData objectForKey:@"kCBAdvDataServiceUUIDs"] && ([[advertisementData objectForKey:@"kCBAdvDataLocalName"] isEqual:SMART_KEY] || [[advertisementData objectForKey:@"kCBAdvDataLocalName"] isEqual:SMART_FINDER])){
    dispatch_async(dispatch_get_main_queue(), ^{
        LGPeripheral *lgPeripheral = [self wrapperByPeripheral:peripheral];
